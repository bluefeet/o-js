...
test('function-args', function (t) {
    ...
    var person = new o.Trait(function(){
        this.attribute( 'firstName', { type:o.nonEmptyStringType, writer:true } );
        this.attribute( 'lastName', { type:o.nonEmptyStringType, writer:true } );
        this.attribute( 'gender', { type:new o.EnumType(['m', 'f']), writer:true } );
